...
const int ERR_SAMPLING_RATE_TOO_LOW = 2010;
const int ERR_FAILED_TO_WRITE_ALL_SAMPLES = 2011;
const int ERR_FAILED_TO_OPEN_CUSTOM_WAVE = 2012;
const int ERR_INVALID_REQUEST = 2013;
